...
public record SavedCartItemDto(
    ...
    public static SavedCartItemDto fromEntity(SavedCartItemEntity e) {
        return new SavedCartItemDto(e.getProductId(), e.getVariantId(), e.getSku(), e.getSlug(),
                e.getTitle(), e.getImageUrl(), e.getVariantLabel(), e.getUnitPriceSource(),
                e.getSourceCurrency(), e.getQuantity(), e.getMoq(), e.getUnitPriceDisplay(),
                e.getDisplayCurrency(), e.getDisplaySymbol());
    }
}
