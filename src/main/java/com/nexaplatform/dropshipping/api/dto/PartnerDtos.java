...
public final class PartnerDtos {
    ...
    public record ConnectShopRequest(@NotBlank String platform, @NotBlank String shopHandle, @NotBlank String accessToken) {}
    ...
    public record CreateOrderRequest(
            ...
            @Valid @NotNull AddressInput shippingAddress,
            @Valid AddressInput billingAddress,
            @NotEmpty List<@Valid OrderItemInput> items,
            String notes
    ) {}

    public record OrderItemView(UUID productId, UUID variantId, int quantity, BigDecimal unitPrice, BigDecimal lineTotal) {}
