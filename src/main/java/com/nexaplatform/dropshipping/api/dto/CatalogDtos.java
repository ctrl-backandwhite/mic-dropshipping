...
public final class CatalogDtos {
    ...
    public record IngestProductRequest(
            ...
            UUID supplierId,
            UUID categoryId,
            List<IngestImage> images,
            List<IngestVariantOption> options,
            List<IngestVariant> variants,
    ...
    public record IngestSupplierRequest(
            @NotBlank String source,
            @NotBlank String externalId,
            String name,
            String nameZh,
    ...
    public record IngestCategoryRequest(
    ...
    public record ProductSummaryView(
            ...
            String title,
            String mainImage,
            BigDecimal basePrice,         // legacy display in CNY (kept for back-compat)
    ...
    public record ProductDetailView(
            ...
            List<VariantOptionView> variantOptions,
