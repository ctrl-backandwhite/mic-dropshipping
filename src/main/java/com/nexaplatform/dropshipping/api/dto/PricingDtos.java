...
public final class PricingDtos {
    ...
    public record PriceRuleView(
            UUID id,
            String scope,
            UUID scopeId,
            String marginType,
            BigDecimal marginValue,
            BigDecimal minCostUsd,
    ...
    public record PriceRuleRequest(
            @NotNull @Pattern(regexp = "^(GLOBAL|CATEGORY|SUPPLIER|PRODUCT|VARIANT)$") String scope,
            UUID scopeId,
            @NotNull @Pattern(regexp = "^(PERCENTAGE|FIXED)$") String marginType,
            @NotNull BigDecimal marginValue,
            BigDecimal minCostUsd,
            BigDecimal maxCostUsd,
            Boolean active,
            Integer position,
