...
public final class WalletDtos {
    ...
    public record WalletView(
            ...
            long holdUsdCents,
            long availableUsdCents,
            String currencyDefault,
            String status,
            BigDecimal balanceDisplay,
    ...
    public record RechargeRequest(
            @NotNull @Pattern(regexp = "^(CARD|PAYPAL|USDT)$") String method,
            @NotNull @Positive Long amountUsdCents,
            String cryptoChain,         // TRC20 | ERC20 | BEP20 (USDT only)
    ...
    public record AdjustRequest(
            @NotNull Long signedAmountUsdCents,
