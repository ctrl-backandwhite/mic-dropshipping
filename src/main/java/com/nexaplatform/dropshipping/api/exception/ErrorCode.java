...
public enum ErrorCode {
    ...
    BR001("No se pudo completar la operación. Revisa los datos e inténtalo de nuevo.",
            ...
            "Não foi possível concluir a operação. Verifique os dados e tente novamente.", "无法完成操作。请检查输入后重试。",
            ...
            "De bewerking kon niet worden voltooid. Controleer je gegevens en probeer het opnieuw."), ENF001(
                    "No se encontró el recurso solicitado.", "The requested item was not found.",
                    "O recurso solicitado não foi encontrado.", "未找到请求的资源。", "La ressource demandée est introuvable.",
                    "Die angeforderte Ressource wurde nicht gefunden.", "La risorsa richiesta non è stata trovata.",
                    "De gevraagde bron is niet gevonden."), AE001(
                            "Hay datos no válidos. Revisa los campos e inténtalo de nuevo.",
                            "Some data is invalid. Please review the fields and try again.",
                            "Alguns dados são inválidos. Reveja os campos e tente novamente.", "部分数据无效。请检查字段后重试。",
                            ...
                            "Sommige gegevens zijn ongeldig. Controleer de velden en probeer het opnieuw."), DM001(
                                    ...
                                    "De bron bestaat al of is in conflict met de huidige status."), CF001(
                                            "El recurso ya existe o hay un conflicto con el estado actual.",
                                            "The resource already exists or conflicts with the current state.",
                                            "O recurso já existe ou há um conflito com o estado atual.",
                                            "资源已存在或与当前状态冲突。",
                                            "La ressource existe déjà ou est en conflit avec l'état actuel.",
                                            "Die Ressource existiert bereits oder steht im Konflikt mit dem aktuellen Status.",
                                            "La risorsa esiste già o è in conflitto con lo stato attuale.",
                                            "De bron bestaat al of is in conflict met de huidige status."), RL001(
                                                    ...
                                                    "Te veel verzoeken. Wacht enkele seconden en probeer het opnieuw."), IS001(
                                                            ...
                                                            "Ocorreu um erro inesperado. Tente novamente dentro de alguns minutos.",
                                                            "发生意外错误。请稍后几分钟再试。",
    ...
    SE001("No tienes permiso para hacer esto.", "You do not have permission to do this.",
            ...
            "Vous n'avez pas l'autorisation d'effectuer cette action.", "Du hast keine Berechtigung, das zu tun.",
            "Non hai i permessi per farlo.",
            "Je hebt geen toestemming om dit te doen."), SE002("El correo o la contraseña no son correctos.",
                    "The email or password is incorrect.", "O e-mail ou a palavra-passe não estão corretos.",
                    "邮箱或密码不正确。", "L'adresse e-mail ou le mot de passe est incorrect.",
                    "E-Mail-Adresse oder Passwort sind nicht korrekt.", "L'email o la password non sono corretti.",
                    "Het e-mailadres of wachtwoord is onjuist."), MFA_REQUIRED(
                            "Introduce el código de verificación de tu aplicación de autenticación.",
                            "Enter the verification code from your authenticator app.",
                            "Introduz o código de verificação da tua aplicação de autenticação.", "请输入身份验证器应用中的验证码。",
                            ...
                            "Voer de verificatiecode uit je authenticator-app in."), MFA_INVALID(
                                    "El código de verificación no es correcto o ha caducado.",
    ...
    ORDER_NOT_CANCELLABLE(
            ...
            "Deze bestelling is al verwerkt en kan niet meer worden geannuleerd. Als je hem wilt retourneren, neem dan contact met ons op zodra je hem hebt ontvangen en wij regelen de retour."), REFUND_NOT_POSSIBLE(
                    ...
                    "We konden het bedrag niet terugstorten naar je oorspronkelijke betaalmethode. Je kunt annuleren en het geld in je wallet ontvangen, of neem contact met ons op en wij lossen het op."), ORDER_NOT_FOUND(
                            "No se encontró el pedido.", "The order could not be found.",
                            "Não foi possível encontrar o pedido.", "找不到该订单。", "Commande introuvable.",
                            "Bestellung nicht gefunden.", "Ordine non trovato.",
                            "Bestelling niet gevonden."), WALLET_INSUFFICIENT_BALANCE(
                                    "No tienes saldo suficiente en tu billetera.",
                                    "You don't have enough balance in your wallet.",
                                    "Não tem saldo suficiente na sua carteira.", "您的钱包余额不足。",
                                    "Vous n'avez pas assez de solde dans votre portefeuille.",
                                    "Du hast nicht genügend Guthaben in deinem Wallet.",
                                    "Non hai saldo sufficiente nel tuo wallet.",
                                    "Je hebt niet genoeg saldo in je wallet."), MOQ_NOT_REACHED(
                                            "No llegas al pedido mínimo de uno de los productos. Puedes completarlo mezclando colores o tallas del mismo producto.",
                                            ...
                                            "Je haalt de minimale bestelhoeveelheid van een van de producten niet. Je kunt die aanvullen met andere kleuren of maten van hetzelfde product."), PURCHASE_NOT_EXPORTED(
                                                    ...
                                                    "Download eerst het herverpakkingsbestand en upload het naar Yunfulfillment: het ordernummer geeft het OMS terug bij de import."), CART_EMPTY(
                                                            "Tu carrito debe tener al menos un producto.",
                                                            "Your cart must have at least one product.",
                                                            "O seu carrinho deve ter pelo menos um produto.",
                                                            "您的购物车至少需要一件商品。",
                                                            "Votre panier doit contenir au moins un produit.",
                                                            "Dein Warenkorb muss mindestens ein Produkt enthalten.",
                                                            "Il tuo carrello deve contenere almeno un prodotto.",
                                                            "Je winkelwagen moet minstens één product bevatten."), SHIPPING_ADDRESS_REQUIRED(
                                                                    "Debes indicar una dirección de envío.",
                                                                    "A shipping address is required.",
                                                                    "É necessário indicar uma morada de envio.",
                                                                    "需要填写收货地址。",
                                                                    "Une adresse de livraison est requise.",
                                                                    "Eine Lieferadresse ist erforderlich.",
                                                                    "È necessario un indirizzo di spedizione.",
                                                                    "Een verzendadres is verplicht."), PLAN_COUNTRY_REQUIRED(
                                                                            "Selecciona un país en tu perfil antes de contratar un plan.",
                                                                            "Select a country in your profile before subscribing to a plan.",
                                                                            "Selecione um país no seu perfil antes de contratar um plano.",
                                                                            "订阅套餐前,请先在个人资料中选择国家/地区。",
                                                                            ...
                                                                            "Selecteer een land in je profiel voordat je een abonnement afsluit."), PLAN_CARD_REQUIRED(
                                                                                    "Añade una tarjeta en tu perfil antes de contratar un plan.",
                                                                                    "Add a card in your profile before subscribing to a plan.",
                                                                                    "Adicione um cartão no seu perfil antes de contratar um plano.",
                                                                                    "订阅套餐前,请先在个人资料中添加银行卡。",
                                                                                    ...
                                                                                    "Voeg een kaart toe in je profiel voordat je een abonnement afsluit."), FREE_TRIAL_ALREADY_USED(
                                                                                            ...
                                                                                            "Je hebt je gratis proefperiode van 15 dagen al gebruikt. Kies een betaald abonnement."), CART_ITEM_UNAVAILABLE(
                                                                                                    ...
                                                                                                    "Een van de producten in je winkelwagen is niet meer beschikbaar omdat de catalogus is bijgewerkt. Verwijder het en voeg het opnieuw toe vanuit de catalogus."), DELETION_CODE_INVALID(
                                                                                                            ...
                                                                                                            "De verwijdercode is ongeldig of verlopen."), PRODUCT_SOURCE_URL_INVALID(
                                                                                                                    "El enlace de origen no es válido: debe ser una dirección http(s) de 1688 o Alibaba.",
