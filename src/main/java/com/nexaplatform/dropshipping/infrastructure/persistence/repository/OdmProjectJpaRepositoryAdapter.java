...
/** Spring Data JPA adapter backing the {@code OdmProjectRepository} domain port. */
public interface OdmProjectJpaRepositoryAdapter extends JpaRepository<OdmProjectEntity, UUID> {
