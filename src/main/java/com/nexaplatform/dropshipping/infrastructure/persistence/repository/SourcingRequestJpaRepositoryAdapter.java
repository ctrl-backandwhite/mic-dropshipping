...
/** Spring Data JPA adapter backing the {@code SourcingRequestRepository} domain port. */
public interface SourcingRequestJpaRepositoryAdapter extends JpaRepository<SourcingRequestEntity, UUID> {
