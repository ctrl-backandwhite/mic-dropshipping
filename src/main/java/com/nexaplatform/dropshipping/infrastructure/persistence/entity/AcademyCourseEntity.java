...
public class AcademyCourseEntity extends BaseEntity {
    ...
    @Column(length = 120) private String instructor;
    @Column(name = "duration_minutes") private Integer durationMinutes;
    @Column(name = "cover_url", length = 800) private String coverUrl;
    @Column(name = "video_url", length = 800) private String videoUrl;
    @Column(nullable = false, length = 8)
    @Builder.Default private String locale = "es";
    @Column(nullable = false, length = 20)
    @Builder.Default private String level = "BEGINNER";
