...
public class SourcingRequestEntity extends BaseEntity {
    ...
    @Column(name = "source_url", nullable = false, length = 800) private String sourceUrl;
    @Column(name = "title_hint", length = 400)  private String titleHint;
    @Column(nullable = false, length = 20)      @Builder.Default private String status = "PENDING";
    @Column(name = "plan_quota", length = 20)   private String planQuota;
