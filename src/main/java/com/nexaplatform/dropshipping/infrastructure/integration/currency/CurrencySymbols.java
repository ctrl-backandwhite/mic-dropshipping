...
public final class CurrencySymbols {
    ...
    private static final Map<String, String[]> META = Map.ofEntries(Map.entry("USD", new String[]{"$", "US Dollar"}),
            Map.entry("EUR", new String[]{"€", "Euro"}), Map.entry("GBP", new String[]{"£", "British Pound"}),
            Map.entry("JPY", new String[]{"¥", "Japanese Yen"}), Map.entry("CNY", new String[]{"¥", "Chinese Yuan"}),
            ...
            Map.entry("INR", new String[]{"₹", "Indian Rupee"}), Map.entry("BRL", new String[]{"R$", "Brazilian Real"}),
            Map.entry("MXN", new String[]{"$", "Mexican Peso"}), Map.entry("ARS", new String[]{"$", "Argentine Peso"}),
            Map.entry("CLP", new String[]{"$", "Chilean Peso"}), Map.entry("COP", new String[]{"$", "Colombian Peso"}),
            Map.entry("PEN", new String[]{"S/", "Peruvian Sol"}), Map.entry("AED", new String[]{"د.إ", "UAE Dirham"}),
            Map.entry("SAR", new String[]{"﷼", "Saudi Riyal"}), Map.entry("TRY", new String[]{"₺", "Turkish Lira"}),
            Map.entry("RUB", new String[]{"₽", "Russian Ruble"}),
            Map.entry("ZAR", new String[]{"R", "South African Rand"}),
            Map.entry("PLN", new String[]{"zł", "Polish Zloty"}), Map.entry("SEK", new String[]{"kr", "Swedish Krona"}),
            Map.entry("NOK", new String[]{"kr", "Norwegian Krone"}),
            Map.entry("DKK", new String[]{"kr", "Danish Krone"}), Map.entry("THB", new String[]{"฿", "Thai Baht"}),
            ...
            Map.entry("ILS", new String[]{"₪", "Israeli Shekel"}), Map.entry("CZK", new String[]{"Kč", "Czech Koruna"}),
