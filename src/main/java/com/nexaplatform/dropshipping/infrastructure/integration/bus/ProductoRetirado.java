 ...
 */
public record ProductoRetirado(int version, String evento, /**
                                                            ...
                                                            */
String ocurrido, String externalId, String slug, String motivo) {

    public static ProductoRetirado de(String externalId, String slug, String motivo) {
        return new ProductoRetirado(EventoBus.VERSION, "producto.retirado", Instant.now().toString(), externalId, slug,
                motivo);
    }
}
