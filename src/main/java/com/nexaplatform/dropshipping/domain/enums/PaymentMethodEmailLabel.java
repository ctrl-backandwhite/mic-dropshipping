...
public enum PaymentMethodEmailLabel {
    ...
    SUBJECT(new Translations("Código para eliminar tu método de pago · NX036",
            "Code to remove your payment method · NX036",
            "Código para remover o teu método de pagamento · NX036",
            "删除支付方式的验证码 · NX036",
            "Code pour supprimer votre moyen de paiement · NX036",
            "Code zum Entfernen deiner Zahlungsmethode · NX036",
            "Codice per rimuovere il tuo metodo di pagamento · NX036",
            "Code om je betaalmethode te verwijderen · NX036")),
    TITLE(new Translations("Confirma la eliminación", "Confirm removal", "Confirma a remoção", "确认删除",
            "Confirmer la suppression", "Entfernung bestätigen", "Conferma la rimozione", "Verwijdering bevestigen")),
