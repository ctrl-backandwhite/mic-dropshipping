...
public enum InvoiceLabel {
    ...
    INVOICE(new Translations("Factura", "Invoice", "Fatura", "发票", "Facture", "Rechnung", "Fattura",
            "Factuur")), TITLE_PAID(
                    new Translations("Pago confirmado", "Payment confirmed", "Pagamento confirmado", "付款已确认",
                            "Paiement confirmé", "Zahlung bestätigt", "Pagamento confermato",
                            "Betaling bevestigd")), INTRO(
                                    new Translations("Gracias por tu compra. Aquí tienes la factura de tu pedido.",
                                            ...
                                            "Bedankt voor je aankoop. Hier is de factuur van je bestelling.")), BILL_TO(
                                                    new Translations("Facturar a", "Bill to", "Faturar para", "账单收件人",
                                                            "Facturer à", "Rechnung an", "Fatturare a",
                                                            "Factureren aan")), ISSUE_DATE(
                                                                    new Translations("Fecha de emisión", "Issue date",
                                                                            "Data de emissão", "开具日期",
                                                                            "Date d'émission", "Ausstellungsdatum",
                                                                            "Data di emissione",
                                                                            "Datum van uitgifte")), PAYMENT_METHOD(
                                                                                    new Translations("Método de pago",
                                                                                            "Payment method",
                                                                                            "Método de pagamento",
     ...
     */
    CUSTOMS_DUTY(new Translations("Arancel UE", "EU customs duty", "Taxa aduaneira UE", "欧盟关税", "Droit de douane UE",
            "EU-Zoll", "Dazio doganale UE", "EU-douanerechten")), TOTAL(
                    new Translations(Word.TOTAL, Word.TOTAL, Word.TOTAL, "总计", Word.TOTAL, "Gesamt", "Totale",
                            "Totaal")),
    ...
    TAX_ID(new Translations("NIF-IVA", "VAT", "NIF-IVA", "增值税号", "N° de TVA", "USt-IdNr.", "P. IVA",
            "Btw-nr.")), TAX_ID_PREFIX(
                    new Translations("NIF-IVA: ", "VAT: ", "NIF-IVA: ", "增值税号: ", "N° de TVA : ", "USt-IdNr.: ",
                            "P. IVA: ", "Btw-nr.: ")), VERIFY(
                                    new Translations("Verificar factura", "Verify invoice", "Verificar fatura", "验证发票",
                                            "Vérifier la facture", "Rechnung prüfen", "Verifica fattura",
                                            "Factuur verifiëren")), VERIFY_NOTE(
                                                    new Translations(
                                                            ...
                                                            "Elektronisch gegenereerd document. Scan de QR-code om de echtheid van deze factuur te verifiëren.")), CTA_VIEW(
                                                                    new Translations("Ver pedido y factura",
                                                                            "View order & invoice",
                                                                            "Ver pedido e fatura", "查看订单和发票",
                                                                            "Voir la commande et la facture",
                                                                            "Bestellung & Rechnung ansehen",
                                                                            "Vedi ordine e fattura",
                                                                            "Bestelling & factuur bekijken")), CTA_DOWNLOAD(
                                                                                    new Translations(
                                                                                            ...
                                                                                            "Scarica fattura (PDF)",
                                                                                            "Factuur downloaden (PDF)")), RECEIPT_NOTE(
                                                                                                    new Translations(
                                                                                                            "Este es un comprobante de tu pedido. Conserva esta factura.",
    ...
    EU_RESPONSIBLE(
            new Translations("Operador económico responsable en la UE", "Responsible economic operator in the EU",
                    "Operador económico responsável na UE", "欧盟责任经济经营者", "Opérateur économique responsable dans l'UE",
                    "Verantwortlicher Wirtschaftsakteur in der EU", "Operatore economico responsabile nell'UE",
                    "Verantwoordelijke marktdeelnemer in de EU")), EU_RESPONSIBLE_NOTE(
                            new Translations("Datos publicados conforme al artículo 16 del Reglamento (UE) 2023/988.",
