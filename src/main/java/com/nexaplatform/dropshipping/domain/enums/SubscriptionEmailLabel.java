...
public enum SubscriptionEmailLabel {
    ...
    SUBJECT(new Translations("Tu plan en NX036", "Your NX036 plan", "O teu plano na NX036", "你的 NX036 套餐",
            "Votre forfait NX036", "Dein NX036-Tarif", "Il tuo piano NX036", "Je NX036-abonnement")), TITLE(
                    new Translations("Plan contratado", "Plan activated", "Plano contratado", "套餐已开通", "Forfait activé",
                            "Tarif aktiviert", "Piano attivato", "Abonnement geactiveerd")), BODY_TRIAL(
                                    new Translations(
                                            ...
                                            "Hallo {name}, je bent je gratis proefperiode van 15 dagen van het {plan}-abonnement gestart. Deze eindigt op {date}; kies daarna een betaald abonnement om het platform te blijven gebruiken.")), BODY_PAID(
                                                    new Translations(
                                                            ...
                                                            "Hallo {name}, je hebt het {plan}-abonnement afgesloten. Bedankt dat je voor NX036 kiest! Je kunt je abonnement altijd bekijken of wijzigen in je profiel.")), CTA(
                                                                    new Translations("Ver mi plan", "View my plan",
                                                                            "Ver o meu plano", "查看我的套餐",
                                                                            "Voir mon forfait", "Meinen Tarif ansehen",
                                                                            "Vedi il mio piano",
