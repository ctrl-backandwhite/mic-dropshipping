...
public enum UnsubscribeLabel {
    ...
    RESUBSCRIBE_LABEL(new Translations("Volver a recibir novedades", "Receive new arrivals again",
            "Voltar a receber novidades", "重新接收上新", "Recevoir à nouveau les nouveautés",
            "Neuheiten wieder erhalten", "Ricevi di nuovo le novità", "Weer nieuwe producten ontvangen")),
    ON_TITLE(new Translations("Suscripción reactivada", "Subscription reactivated", "Subscrição reativada", "订阅已恢复",
            "Abonnement réactivé", "Abo reaktiviert", "Iscrizione riattivata", "Abonnement heractiveerd")),
    ON_MESSAGE(new Translations("Volverás a recibir nuestros correos con las novedades del catálogo.",
    ...
    INVALID_TITLE(new Translations("Enlace no válido", "Invalid link", "Ligação inválida", "链接无效",
            "Lien non valide", "Ungültiger Link", "Link non valido", "Ongeldige link")),
    INVALID_MESSAGE(new Translations("Este enlace de baja no es válido o ha caducado.",
    ...
    HOME_LABEL(new Translations("Ir a NX036", "Go to NX036", "Ir para a NX036", "前往 NX036",
