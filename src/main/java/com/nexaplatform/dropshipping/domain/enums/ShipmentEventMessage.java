...
public enum ShipmentEventMessage {
    ...
    REGISTERED(new Translations("Envío registrado", "Shipment registered", "Envio registado", "已登记发货",
            "Expédition enregistrée", "Sendung registriert", "Spedizione registrata",
            "Zending geregistreerd")), PICKED_UP(
                    new Translations("Recogido por el transportista", "Picked up by the carrier",
                            "Recolhido pela transportadora", "承运商已取件", "Pris en charge par le transporteur",
                            "Vom Spediteur abgeholt", "Ritirato dal corriere",
                            "Opgehaald door de vervoerder")), IN_TRANSIT(
                                    new Translations("En tránsito internacional", "In international transit",
                                            "Em trânsito internacional", "国际运输中", "En transit international",
                                            "Im internationalen Transit", "In transito internazionale",
                                            "In internationaal transport")), ARRIVED_COUNTRY(
                                                    new Translations("Llegó al país de destino",
                                                            "Arrived in destination country",
                                                            "Chegou ao país de destino", "已到达目的地国家",
                                                            "Arrivé dans le pays de destination",
                                                            "Im Zielland angekommen",
                                                            "Arrivato nel paese di destinazione",
                                                            "Aangekomen in land van bestemming")), OUT_FOR_DELIVERY(
                                                                    new Translations("En reparto", "Out for delivery",
                                                                            "Saiu para entrega", "正在派送",
                                                                            "En cours de livraison", "In Zustellung",
                                                                            "In consegna",
                                                                            "Onderweg voor bezorging")), DELIVERED(
                                                                                    new Translations(
