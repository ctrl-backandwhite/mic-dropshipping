...
public enum NewProductsEmailLabel {
    ...
    SUBJECT(new Translations("Nuevos productos en NX036 · Novedades de hoy", "New products at NX036 · Today's arrivals",
            ...
            "Nuovi prodotti su NX036 · Le novità di oggi", "Nieuwe producten bij NX036 · Vandaag toegevoegd")), TITLE(
                    new Translations("Nuevos productos disponibles hoy", "New products available today",
                            ...
                            "Nieuwe producten vanaf vandaag beschikbaar")), INTRO(
                                    new Translations(
                                            ...
                                            "We hebben nieuwe items aan de catalogus toegevoegd. Hier een selectie per categorie; log in om alles te zien.")), CTA(
                                                    new Translations("Ver todas las novedades", "See all new arrivals",
                                                            "Ver todas as novidades", "查看全部新品",
                                                            "Voir toutes les nouveautés", "Alle Neuheiten ansehen",
                                                            "Vedi tutte le novità",
                                                            "Bekijk alle nieuwe items")), FOOTER(
                                                                    new Translations(
                                                                            ...
                                                                            "Je ontvangt deze e-mail omdat je bij NX036 bent geregistreerd. Je wordt gevraagd in te loggen om de volledige lijst te zien.")), UNSUBSCRIBE(
                                                                                    new Translations(
                                                                                            "Darse de baja de los correos de novedades",
                                                                                            "Unsubscribe from new-arrival emails",
                                                                                            "Cancelar a subscrição dos e-mails de novidades",
                                                                                            "取消订阅上新邮件",
                                                                                            "Se désabonner des e-mails de nouveautés",
                                                                                            "Neuheiten-E-Mails abbestellen",
                                                                                            "Annulla l'iscrizione alle email sulle novità",
                                                                                            "Uitschrijven voor nieuwe-producten-mails"));
