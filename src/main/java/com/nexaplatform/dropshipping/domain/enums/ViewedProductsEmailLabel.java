...
public enum ViewedProductsEmailLabel {
    ...
    SUBJECT(new Translations("Lo que has estado mirando en NX036", "What you've been looking at on NX036",
            "O que tem andado a ver na NX036", "您最近在 NX036 浏览过的商品", "Ce que vous avez consulté sur NX036",
            "Was du dir bei NX036 angesehen hast", "Quello che hai guardato su NX036",
            "Wat je hebt bekeken op NX036")), TITLE(
                    new Translations("Sigue donde lo dejaste", "Pick up where you left off", "Continue de onde ficou",
                            "继续您上次浏览的商品", "Reprenez où vous en étiez", "Mach da weiter, wo du aufgehört hast",
                            "Riprendi da dove eri rimasto", "Ga verder waar je was gebleven")), INTRO(
                                    new Translations(
                                            ...
                                            "Dit zijn de producten die je de afgelopen drie dagen hebt bekeken, voor het geval er nog een openstond.")), CTA(
                                                    new Translations("Ver mi historial completo", "See my full history",
                                                            "Ver o meu histórico completo", "查看我的完整浏览记录",
                                                            "Voir tout mon historique",
                                                            "Meinen gesamten Verlauf ansehen",
                                                            "Vedi la mia cronologia completa",
                                                            "Bekijk mijn volledige geschiedenis")), FOOTER(
                                                                    new Translations(
                                                                            ...
                                                                            "Je ontvangt deze e-mail omdat je ingelogd productpagina's op NX036 hebt geopend. Die geschiedenis wordt 90 dagen bewaard en staat uitgelegd in de voorwaarden.")), UNSUBSCRIBE(
                                                                                    new Translations(
                                                                                            "Dejar de recibir este recordatorio",
                                                                                            "Stop receiving this reminder",
                                                                                            "Deixar de receber este lembrete",
                                                                                            "取消接收此提醒",
                                                                                            "Ne plus recevoir ce rappel",
                                                                                            "Diese Erinnerung nicht mehr erhalten",
                                                                                            "Non ricevere più questo promemoria",
