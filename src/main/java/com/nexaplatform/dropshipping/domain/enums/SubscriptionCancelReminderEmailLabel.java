...
public enum SubscriptionCancelReminderEmailLabel {
    ...
    SUBJECT(new Translations("Tu plan se cancela pronto · NX036", "Your plan is ending soon · NX036",
            "O teu plano termina em breve · NX036", "你的套餐即将取消 · NX036",
            "Votre forfait se termine bientôt · NX036", "Dein Tarif endet bald · NX036",
            "Il tuo piano sta per terminare · NX036", "Je abonnement eindigt binnenkort · NX036")),
    TITLE(new Translations("Tu plan se cancela pronto", "Your plan is ending soon", "O teu plano termina em breve",
            "你的套餐即将取消", "Votre forfait se termine bientôt", "Dein Tarif endet bald",
            "Il tuo piano sta per terminare", "Je abonnement eindigt binnenkort")),
    BODY(new Translations(
            ...
            "Ter herinnering: je {plan}-abonnement wordt op {date} opgezegd. Tot dan behoud je alle functies. "
                    + "Wil je het blijven gebruiken, sluit dan opnieuw een abonnement af voordat het eindigt.")),
