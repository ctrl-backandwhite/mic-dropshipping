...
public enum OrderEmailLabel {
    ...
    REFUND_L_ORDER("Número de pedido", "Order number", "Número do pedido", "订单编号", "Numéro de commande",
            "Bestellnummer", "Numero d'ordine", "Bestelnummer"),
    REFUND_L_DATE("Fecha del reembolso", "Refund date", "Data do reembolso", "退款日期", "Date du remboursement",
            "Datum der Rückerstattung", "Data del rimborso", "Datum terugbetaling"),
    REFUND_L_AMOUNT("Importe reembolsado", "Refunded amount", "Valor reembolsado", "退款金额", "Montant remboursé",
            "Erstatteter Betrag", "Importo rimborsato", "Terugbetaald bedrag"),
    REFUND_L_ITEMS("Artículos", "Items", "Artigos", "商品", "Articles", "Artikel", "Articoli", "Artikelen"),
    REFUND_L_DEST("Destino del reembolso", "Refund destination", "Destino do reembolso", "退款去向",
            "Destination du remboursement", "Ziel der Rückerstattung", "Destinazione del rimborso",
            "Bestemming terugbetaling"),
    REFUND_DEST_WALLET("Billetera (inmediato)", "Wallet (instant)", "Carteira (imediato)", "钱包(即时到账)",
            "Portefeuille (immédiat)", "Wallet (sofort)", "Portafoglio (immediato)", "Portemonnee (direct)"),
    REFUND_DEST_CARD("Tarjeta original (3-5 días hábiles)", "Original card (3–5 business days)",
    ...
    REFUND_DEST_PAYPAL("PayPal (según sus plazos)", "PayPal (per their timelines)", "PayPal (conforme prazos)",
