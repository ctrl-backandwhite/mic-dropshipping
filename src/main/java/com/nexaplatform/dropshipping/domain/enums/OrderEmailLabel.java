...
public enum OrderEmailLabel {
    ...
    SHIPPED_TITLE(new Translations("Tu pedido va en camino", "Your order is on its way", "Seu pedido está a caminho",
            "您的订单正在配送中", "Votre commande est en route", "Deine Bestellung ist unterwegs", "Il tuo ordine è in arrivo",
            "Je bestelling is onderweg")), SHIPPED_BODY(
                    new Translations("Tu pedido <strong>{order}</strong> ha sido despachado y está en camino.",
                            ...
                            "Je bestelling <strong>{order}</strong> is verzonden en is onderweg.")), DELIVERED_TITLE(
                                    new Translations("Tu pedido ha sido entregado", "Your order has been delivered",
                                            "Seu pedido foi entregue", "您的订单已送达", "Votre commande a été livrée",
                                            "Deine Bestellung wurde geliefert", "Il tuo ordine è stato consegnato",
                                            "Je bestelling is bezorgd")), DELIVERED_BODY(
                                                    new Translations(
                                                            ...
                                                            "Je bestelling <strong>{order}</strong> is bezorgd. We hopen dat je ervan geniet!")), PLACED_TITLE(
                                                                    new Translations("Hemos recibido tu pedido",
                                                                            "We received your order",
                                                                            "Recebemos o seu pedido", "我们已收到您的订单",
                                                                            "Nous avons bien reçu votre commande",
                                                                            "Wir haben deine Bestellung erhalten",
                                                                            "Abbiamo ricevuto il tuo ordine",
                                                                            "We hebben je bestelling ontvangen")), PLACED_BODY(
                                                                                    new Translations(
     ...
     */
    PAID_TITLE(new Translations("Pago confirmado", "Payment confirmed", "Pagamento confirmado", "付款已确认",
            "Paiement confirmé", "Zahlung bestätigt", "Pagamento confermato", "Betaling bevestigd")), PAID_BODY(
                    new Translations("Hemos recibido el pago de tu pedido {order}. Ya estamos preparándolo.",
                            ...
                            "We hebben de betaling voor je bestelling {order} ontvangen. We maken hem al klaar.")), REFUNDED_TITLE(
                                    new Translations("Reembolso procesado", "Refund processed", "Reembolso processado",
                                            "退款已处理", "Remboursement traité", "Rückerstattung verarbeitet",
                                            "Rimborso elaborato", "Terugbetaling verwerkt")), REFUNDED_BODY(
                                                    new Translations(
                                                            ...
                                                            "We hebben de terugbetaling voor je bestelling <strong>{order}</strong> verwerkt. Hier zijn de details:")), REFUND_L_ORDER(
                                                                    new Translations("Número de pedido", "Order number",
                                                                            "Número do pedido", "订单编号",
                                                                            "Numéro de commande", "Bestellnummer",
                                                                            "Numero d'ordine",
                                                                            "Bestelnummer")), REFUND_L_DATE(
                                                                                    new Translations(
                                                                                            "Fecha del reembolso",
                                                                                            "Refund date",
                                                                                            "Data do reembolso", "退款日期",
                                                                                            "Date du remboursement",
                                                                                            "Datum der Rückerstattung",
                                                                                            "Data del rimborso",
                                                                                            "Datum terugbetaling")), REFUND_L_AMOUNT(
                                                                                                    new Translations(
                                                                                                            "Importe reembolsado",
                                                                                                            "Refunded amount",
                                                                                                            "Valor reembolsado",
                                                                                                            ...
                                                                                                            "Erstatteter Betrag",
                                                                                                            "Importo rimborsato",
                                                                                                            "Terugbetaald bedrag")), REFUND_L_ITEMS(
                                                                                                                    new Translations(
                                                                                                                            "Artículos",
                                                                                                                            "Items",
                                                                                                                            "Artigos",
                                                                                                                            ...
                                                                                                                            "Artikelen")), REFUND_L_DEST(
                                                                                                                                    new Translations(
                                                                                                                                            ...
                                                                                                                                            "Ziel der Rückerstattung",
                                                                                                                                            "Destinazione del rimborso",
                                                                                                                                            "Bestemming terugbetaling")), REFUND_DEST_WALLET(
                                                                                                                                                    new Translations(
                                                                                                                                                            "Billetera (inmediato)",
                                                                                                                                                            "Wallet (instant)",
                                                                                                                                                            "Carteira (imediato)",
                                                                                                                                                            "钱包(即时到账)",
                                                                                                                                                            "Portefeuille (immédiat)",
                                                                                                                                                            "Wallet (sofort)",
                                                                                                                                                            "Portafoglio (immediato)",
                                                                                                                                                            "Portemonnee (direct)")), REFUND_DEST_CARD(
                                                                                                                                                                    new Translations(
                                                                                                                                                                            "Tarjeta original (3-5 días hábiles)",
                                                                                                                                                                            "Original card (3–5 business days)",
                                                                                                                                                                            "Cartão original (3-5 dias úteis)",
                                                                                                                                                                            "原银行卡(3-5个工作日)",
                                                                                                                                                                            "Carte d'origine (3 à 5 jours ouvrés)",
                                                                                                                                                                            "Ursprüngliche Karte (3–5 Werktage)",
                                                                                                                                                                            "Carta originale (3-5 giorni lavorativi)",
                                                                                                                                                                            "Oorspronkelijke kaart (3–5 werkdagen)")), REFUND_DEST_PAYPAL(
                                                                                                                                                                                    new Translations(
                                                                                                                                                                                            "PayPal (según sus plazos)",
                                                                                                                                                                                            "PayPal (per their timelines)",
                                                                                                                                                                                            "PayPal (conforme prazos)",
                                                                                                                                                                                            "PayPal(按其时效)",
                                                                                                                                                                                            "PayPal (selon ses délais)",
                                                                                                                                                                                            "PayPal (gemäß deren Fristen)",
                                                                                                                                                                                            "PayPal (secondo i suoi tempi)",
                                                                                                                                                                                            "PayPal (volgens hun termijnen)")), TRACK_TITLE(
                                                                                                                                                                                                    new Translations(
                                                                                                                                                                                                            "Actualización de tu envío",
                                                                                                                                                                                                            "Shipment update",
                                                                                                                                                                                                            "Atualização do seu envio",
                                                                                                                                                                                                            "您的物流更新",
                                                                                                                                                                                                            "Mise à jour de votre envoi",
                                                                                                                                                                                                            "Versand-Update",
                                                                                                                                                                                                            "Aggiornamento della spedizione",
                                                                                                                                                                                                            "Update van je verzending")), TRACK_BODY(
                                                                                                                                                                                                                    new Translations(
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            "Je bestelling <strong>{order}</strong> heeft een nieuwe status: <strong>{state}</strong>.")), TRACKING_NUMBER(
                                                                                                                                                                                                                                    new Translations(
                                                                                                                                                                                                                                            "Nº de seguimiento: ",
                                                                                                                                                                                                                                            "Tracking number: ",
                                                                                                                                                                                                                                            "Nº de rastreio: ",
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    new Translations(
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            "Locatie: ")), CTA_TRACK(
                                                                                                                                                                                                                                                                    new Translations(
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            "Segui il mio ordine",
                                                                                                                                                                                                                                                                            "Mijn bestelling volgen")), CTA_VIEW_ORDER(
                                                                                                                                                                                                                                                                                    new Translations(
                                                                                                                                                                                                                                                                                            "Ver pedido",
                                                                                                                                                                                                                                                                                            "View order",
                                                                                                                                                                                                                                                                                            "Ver pedido",
