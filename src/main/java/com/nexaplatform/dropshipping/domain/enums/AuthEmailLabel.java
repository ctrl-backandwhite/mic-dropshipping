...
public enum AuthEmailLabel {
    ...
    INVITE_TITLE(new Translations("Te han invitado a NX036", "You've been invited to NX036",
            "Você foi convidado para a NX036", "您受邀加入 NX036", "Vous êtes invité sur NX036",
            "Du wurdest zu NX036 eingeladen", "Sei stato invitato su NX036", "Je bent uitgenodigd voor NX036")),
    INVITE_BODY(new Translations("Has sido invitado a NX036. Activa tu cuenta para empezar.",
            ...
            "Je bent uitgenodigd voor NX036. Activeer je account om te beginnen.")),
    ...
    DELETE_SUBJECT(new Translations("Confirma la eliminación de tu cuenta — NX036",
            "Confirm your account deletion — NX036", "Confirme a eliminação da sua conta — NX036",
            "确认注销你的账户 — NX036", "Confirmez la suppression de votre compte — NX036",
            "Bestätige die Löschung deines Kontos — NX036", "Conferma l'eliminazione del tuo account — NX036",
            "Bevestig het verwijderen van je account — NX036")),
    DELETE_TITLE(new Translations("Confirma la eliminación de tu cuenta", "Confirm your account deletion",
            "Confirme a eliminação da sua conta", "确认注销你的账户", "Confirmez la suppression de votre compte",
            "Bestätige die Löschung deines Kontos", "Conferma l'eliminazione del tuo account",
            "Bevestig het verwijderen van je account")),
    DELETE_GREETING(new Translations("Hola {name},", "Hi {name},", "Olá {name},", "您好 {name}，",
            "Bonjour {name},", "Hallo {name},", "Ciao {name},", "Hallo {name},")),
    DELETE_INTRO(new Translations(
            ...
            "Je hebt gevraagd je NX036-account te verwijderen. Voer de volgende verificatiecode in om te bevestigen:")),
    DELETE_EXPIRES(new Translations(
            ...
            "Deze code verloopt over 30 minuten. Na bevestiging wordt je account gedeactiveerd en kun je niet meer inloggen.")),
    DELETE_IGNORE(new Translations(
            ...
            "Heb je niet om verwijdering gevraagd, negeer deze e-mail dan: je account blijft actief en er verandert niets.")),
    DELETE_PREHEADER(new Translations("Tu código para confirmar la eliminación de la cuenta caduca en 30 minutos.",
