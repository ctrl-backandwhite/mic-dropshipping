...
public enum AuthEmailLabel {
    ...
    INVITE_TITLE(new Translations("Te han invitado a NX036", "You've been invited to NX036",
            "Você foi convidado para a NX036", "您受邀加入 NX036", "Vous êtes invité sur NX036",
            "Du wurdest zu NX036 eingeladen", "Sei stato invitato su NX036", "Je bent uitgenodigd voor NX036")),
    INVITE_BODY(new Translations("Has sido invitado a NX036 LTD. Activa tu cuenta para empezar.",
            "You've been invited to NX036 LTD. Activate your account to get started.",
            "Você foi convidado para a NX036 LTD. Ative a sua conta para começar.",
            "您受邀加入 NX036 LTD。激活您的账户以开始使用。",
            "Vous avez été invité sur NX036 LTD. Activez votre compte pour commencer.",
            "Du wurdest zu NX036 LTD eingeladen. Aktiviere dein Konto, um loszulegen.",
            "Sei stato invitato su NX036 LTD. Attiva il tuo account per iniziare.",
            "Je bent uitgenodigd voor NX036 LTD. Activeer je account om te beginnen.")),
