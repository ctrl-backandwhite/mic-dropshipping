 ...
 *
 * <p>El {@code carrier} indica qué transportista ofrece la opción. Sin él la opción no se puede
 * despachar: al cobrar hay que saber a quién pedirle la guía, y distintos transportistas pueden
 * devolver códigos que no se parecen en nada —{@code FZZXR} contra {@code 1868922929754472449}— sin
 * que el código diga de quién es cada uno. El cliente no lo ve: la lista se le enseña mezclada y
 * ordenada por precio, que es lo que se decidió.
 *
