...
class PurchaseEconomicsTest {
    ...
    void comparaCosteRealConElTeorico() {
        ...
        PurchaseEconomics e = PurchaseEconomics.of(
                List.of(line(10_000L, 1_000, 3_000)), List.of(2), 25_000L, 2_000L);
    ...
    void sinCosteRegistradoNoHayComparacion() {
        PurchaseEconomics e = PurchaseEconomics.of(
                List.of(line(10_000L, 1_000, 3_000)), List.of(1), null, null);
    ...
    void soloMercanciaOSoloEnvio() {
        ...
        assertThat(PurchaseEconomics.of(lines, List.of(1), 9_000L, null).realCostCnyCents())
                .isEqualTo(9_000L);
        // Que el proveedor no cobre envío no puede tirar por tierra toda la comparación.
        assertThat(PurchaseEconomics.of(lines, List.of(1), null, 500L).realCostCnyCents())
                .isEqualTo(500L);
    }
    ...
    void margenRealConElCambioDelPedido() {
        ...
        PurchaseEconomics e = PurchaseEconomics.of(
                List.of(line(10_000L, 1_000, 3_000)), List.of(1), 12_000L, null);
    ...
    void variasLineas() {
        PurchaseEconomics e = PurchaseEconomics.of(
                List.of(line(10_000L, 1_000, 3_000), line(5_000L, 500, 1_500)),
    ...
    void cantidadParcial() {
        ...
        PurchaseEconomics e = PurchaseEconomics.of(
                List.of(line(10_000L, 1_000, 3_000)), List.of(3), null, null);
    ...
    void sinCambioDerivable() {
        ...
        // sería inventárselo.
        PurchaseEconomics e = PurchaseEconomics.of(
                List.of(line(0L, 1_000, 3_000)), List.of(1), 5_000L, null);
    ...
    void listasDescuadradas() {
        ...
        PurchaseEconomics conNulo = PurchaseEconomics.of(lines, java.util.Arrays.asList(null, 2),
                null, null);
    ...
    void sinIngresoNoHayPorcentaje() {
        PurchaseEconomics e = PurchaseEconomics.of(
                List.of(line(10_000L, 1_000, 0)), List.of(1), 9_000L, null);
