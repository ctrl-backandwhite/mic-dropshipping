...
class CustomerSubscriptionEntityMapperTest {
    ...
    private final CustomerSubscriptionEntityMapper mapper =
            Mappers.getMapper(CustomerSubscriptionEntityMapper.class);

    @Test
    void roundTrip_preservesScalarFields() {
        CustomerSubscription source = CustomerSubscription.builder()
                .id(UUID.randomUUID())
                .status(SubscriptionStatus.ACTIVE)
                .billingPeriod("MONTHLY")
                .stripeCustomerId("cus_1")
                .stripeSubscriptionId("sub_1")
                .currentPeriodStart(Instant.parse("2026-03-01T00:00:00Z"))
                .currentPeriodEnd(Instant.parse("2026-04-01T00:00:00Z"))
                .cancelAt(null)
                .canceledAt(null)
                .trialEndsAt(Instant.parse("2026-03-08T00:00:00Z"))
                .build();
        ...
        assertThat(result).usingRecursiveComparison()
                .ignoringFields(
                        ...
                        "userId", "planId", "planCode", "userEmail", "priceMonthly", "priceYearly")
                .isEqualTo(source);
    }
